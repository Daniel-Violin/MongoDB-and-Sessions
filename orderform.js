...
function submitOrder(){
	...
	info.order = order;
	//added an argument to the info sent to the server so that it also holds onto the customer that made the order
	let urlChunks = document.getElementById("name").href.split('/');
	info.username = urlChunks[urlChunks.length - 1]
